(function ($) {
  ...
  $(".mode").on("click", function () {
    ...
    if (!bodyModeDark) {
      ...
      localStorage.setItem("mode-sabong", "dark-only");
      $("body").addClass("dark-only");
      $("body").removeClass("light");
    }
    if (bodyModeDark) {
      $(".mode").removeClass("active");
      localStorage.setItem("mode-sabong", "light");
      $("body").removeClass("dark-only");
      $("body").addClass("light");
    }
  });
  $("body").addClass(localStorage.getItem("mode-sabong") ? localStorage.getItem("mode-sabong") : "light");
  $(".mode").addClass(localStorage.getItem("mode-sabong") === "dark-only" ? "active" : " ");
